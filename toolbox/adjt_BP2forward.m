function prob = adjt_BP2forward(prob, oid, varargin)
%ADJT_BP2FORWARD   Append adjoint of 'forward' instance from saved solution.
%
...
sol   = forward_read_adjoint(soid, run, lab, 'BP');  % Extract solution and toolbox data from disk
