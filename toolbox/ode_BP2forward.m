function prob = ode_BP2forward(prob, oid, varargin)
%ODE_BP2FORWARD   Append 'forward' instance constructed from saved data.
%
...
[sol,data] = forward_read_solution(soid, run, lab, 'BP');  % Extract solution and toolbox data from disk
